...
Here provides a PyTorch implementation of factorization machine models and common datasets in CTR prediction.
...
| Deep Interest Network | [Guorui Zhou, et al. Deep Interest Network for Click-Through Rate Prediction (Alibaba 2018)](https://arxiv.org/abs/1706.06978) |


## System Architecture

WindlikeRecSys technical architecture follows the classic industrial-grade deep learning recommendation system architecture, including offline data processing, model training, near-line stream processing, online model service, front-end recommendation result display and other modules

TODO: image of this architecture

## Further

Realize the application of embedding-based algorithms in recommendation systems, like word2vec, item2vec and node2vec.